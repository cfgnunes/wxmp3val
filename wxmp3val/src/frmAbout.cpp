...
frmAbout::frmAbout(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size)
{
    ...
    linkEmail = new wxHyperlinkCtrl(this, ID_HYPERLINKCTRL2, _("label"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_CENTRE|wxNO_BORDER, _T("ID_HYPERLINKCTRL2"));
    ...
    linkWebsite = new wxHyperlinkCtrl(this, ID_HYPERLINKCTRL1, _("label"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_CENTRE|wxNO_BORDER, _T("ID_HYPERLINKCTRL1"));
    ...
    linkLicense = new wxHyperlinkCtrl(this, ID_HYPERLINKCTRL3, _("label"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_CONTEXTMENU|wxHL_ALIGN_CENTRE|wxNO_BORDER, _T("ID_HYPERLINKCTRL3"));
    BoxSizer3->Add(linkLicense, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    lblVersion->SetLabel(_("Version ") + APP_VERSION);
    lblAuthor->SetLabel(_("Author: ") + APP_AUTHOR);
    lblWebsite->SetLabel(_("Website: "));
    linkWebsite->SetLabel(APP_WEBSITE);
    linkWebsite->SetURL(APP_WEBSITE);
    lblEmail->SetLabel(_("E-mail: "));
    linkEmail->SetLabel(APP_EMAIL);
    linkEmail->SetURL(_T("mailto:") + APP_EMAIL);
    linkLicense->SetLabel(_T("http://www.gnu.org/licenses/gpl-3.0.html"));
    linkLicense->SetURL(_T("http://www.gnu.org/licenses/gpl-3.0.html"));
